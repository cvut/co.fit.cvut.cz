...
function initPartners() {
    partners = [
...

        {
            ...
            description: "<p>Je nás 48. Jsme tým nadšených vývojářů, projekťáků, designérů a testerů, kteří od roku 2012 touží po jediném – vytvářet ty nejkvalitnější a nejkrásnější appky a weby v celé Evropě. Začali jsme jako parta studentů ČVUT se sídlem nedaleko naší alma mater. Každý z nás vynikal v jiné oblasti a spojoval nás zápal pro technologie. Dneska obýváme kanceláře ve špičce karlínského Danube Housu. V Ackee máme pořád dveře otevřené. Bereme stážisty, juniory i seniory. Jestli není tvá pozice zrovna vypsaná, pošli nám i tak CV, třeba hledáme právě tebe. Momentálně sháníme kandidáty na pozice Android Developer, iOS Developer, Frontend Web Developer.</p>",
            upper_skills: [],
            visit: true
        },

        {
            ...
            description: "<p>IT HUB Prague je součástí skupiny NN Group. Funguje jako mezinárodní IT pro celý NN svět. Máme kolegy z 19 zemí světa, sedíme v centru Prahy na Andělu a naše oddělení se zabývají od hackingu po cloudová řešení. Máme otevřené juniorní pozice v security monitoringu a v týmu ETL administrátorů a konzultantů. Jsme společnost s bohatou historií, jejímž středobodem nejsou pojistné smlouvy, ale lidé. Naší úlohou je poskytování a dodávání IT služeb pro 18 zemí. Našim zákazníkům dodáváme služby především v oblasti bezpečnosti, podpory a údržby regionálních aplikací a systémů, hosting service a jiných podpůrných služeb. Naše osazenstvo je multikulturní a prostředí inspirující.</p>"
...

        {
            ...
            description: "<p>2N primárně vyrábí zařízení jako jsou IP Interkomy, přístupové systémy nebo telekomunikační ústředny a brány. Většina našich SW projektů se odehrává na poli Embedded systémů. Naše produkty stavíme na různých HW platformách (DSP, ARM, Cortex), řada z nich je postavena na Linux. Máme i produkty využívající realtime OS, jako je FreeRTOS a některé produkty stále vyvíjíme i bez OS - tzv. BareMetal. Protože programujeme blízko HW, je náš primární programovací jazyk C. Pracujeme i s dalšími technologiemi, např. JavaScript pro programování web konfiguračních rozhraní, Java a C# pro vývoj backend serverových systémů a i s vývojem nativních aplikací pro mobilní platformy iOS a Android. Nedílnou součástí našeho vývoje je tým UX.</p>" +
            "<div class='expandable'><p>Ve 2N se můžete podílet na vývoji produktů, které jsou považovány za světovou špičku ve svém oboru, a to v týmu zkušených vývojářů, od kterých můžete získávat praktické znalosti. Nabízíme lidem důvěru a prostor řešit úkoly po svém a požadujeme od nich samostatnost a zodpovědnost za výsledek jejich práce. Ve 2N se dostanete k zajímavým technologiím, ale i výzvám. Abychom mohli nabídnout špičkové produkty, často se dostáváme na hranu technologických možností a to je prostor, kde začíná být svět zajímavý a kde je potenciál pro téměř nekonečný rozvoj.</p>" +
            "<p>Pracovat ve 2N je jedinečná možnost, jak nastartovat kariéru v mezinárodní firmě, která je jedničkou v oblasti IP interkomů. Sledujeme poslední trendy v oboru, takže budete pracovat s nejnovějšími technologiemi. Budete hledat nová řešení a práce u nás vás bude bavit. Dokazuje to i fakt, že nejmenší fluktuaci našich zaměstnanců máme právě v oddělení vývoje.</p></div>",
            upper_skills: [],
            visit: false,
            sponsor: true
        },
